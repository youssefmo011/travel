...
class _TripScreenState extends State<TripScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: isPastJourneys ? Colors.white : Colors.transparent,
                                borderRadius: BorderRadius.circular(30),
                  ...
                  const SizedBox(height: 140), // Space for floating button
                ],
              ),
            ),
          ),
          // Floating Button
          Positioned(
            bottom: 120, // Adjusted to be above the bottom nav
            left: 24,
            right: 24,
  ...
  Widget _buildTimelinePoint(bool isActive, {bool isSmall = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isActive ? const Color(0xFF6D8B6D) : Colors.grey.shade300,
        shape: BoxShape.circle,
      ),
      child: isActive && !isSmall
  ...
  Widget _buildTripCard({
    ...
    return Container(
      ...
      child: Row(
        children: [
          ClipRRect(
            borderRadius: BorderRadius.circular(100), // Circular image as per design
            child: Image.asset(
              image,
              width: 70,
              height: 70,
